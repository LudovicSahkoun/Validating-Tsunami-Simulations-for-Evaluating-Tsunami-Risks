...
def make_dtopo(makeplots=False):
    ...
    dtopo_fname = os.path.join(scratch_dir, "dtopo_NetLogo.tt3")
    ...
    usgs_subfault.length = 60.e3
    usgs_subfault.width = 30.e3
    usgs_subfault.depth = 20.e3
    usgs_subfault.slip = 15.
    usgs_subfault.rake = 15.
    usgs_subfault.dip = 16.
    usgs_subfault.longitude = 7.7 #7.44
    usgs_subfault.latitude = 43.4 #43.725
    ...
    if os.path.exists(dtopo_fname):
        ...
        x = numpy.linspace(7.1, 7.79, 100)
        y = numpy.linspace(43.35, 43.86, 100)
        times = [1.]
