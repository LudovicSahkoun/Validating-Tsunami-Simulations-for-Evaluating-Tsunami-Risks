...
#------------------------------
    ...
    # clawdata.lower[0] = 5.49      # west longitude
    # clawdata.upper[0] = 8.3       # east longitude

    # clawdata.lower[1] = 41.4       # south latitude
    # clawdata.upper[1] = 44.68       # north latitude
    # Lower and upper edge of computational domain:
    clawdata.lower[0] = 7.177       # west longitude
    clawdata.upper[0] = 7.79       # east longitude

    clawdata.lower[1] = 43.353       # south latitude
    clawdata.upper[1] = 43.86       # north latitude
    ...
    if clawdata.output_style==1:
        ...
        clawdata.num_output_times = 16 # Nombre d'images - initiallement 18
        clawdata.tfinal = 4 * 3600. # Nombre d'heures - initialement 9 # Un demie-heure
    ...
    flagregion2 = FlagRegion(num_dim=2)  # so far only 2D supported
    flagregion2.name = 'Region_domain'
    flagregion2.minlevel = 3
    flagregion2.maxlevel = 3
    flagregion2.t1 = 0.
    flagregion2.t2 = 1e9
    flagregion2.spatial_region_type = 1  # Rectangle
    flagregion2.spatial_region = [7.42,7.44,43.73,43.755]
    ...
    # X is longitude (east, west)
    # Y is latitude (north, south)
    rundata.regiondata.regions.append([1, 1, 0, 1e9, clawdata.lower[0],clawdata.upper[0],clawdata.lower[1],clawdata.upper[1]]) # Low res area
    rundata.regiondata.regions.append([3, 3, 0, 1e9, 7.41,7.45,43.72,43.76]) # High Res Monaco
...
#-------------------
    ...
    #    [topotype, fname]
    topo_path = os.path.join(scratch_dir, 'NetLogo.asc')
    ...
    #   [topotype, fname]
    dtopo_path = os.path.join(scratch_dir, 'dtopo_NetLogo.tt3')
